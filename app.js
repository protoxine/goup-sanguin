//on init tout les id humain dans une seul constante//
const humans_parent = document.getElementById("humans");
//je creer un objet type de sang qui va regrouper tout les groupe compatible//
const BLOOD_TYPES = {
  "O−": ["O−", "O+", "A−", "A+", "B−", "B+", "AB−", "AB+"],
  "O+": ["O+", "A+", "B+", "AB+"],
  "A−": ["A−", "A+", "AB−", "AB+"],
...
//je met tout les balises de même nom dans une meme constante//
...
//une fonction pour reset le projet
function reset() {
  change();
...
//les fonction pour faire l'anim du sang//
function timeout(ms) {
